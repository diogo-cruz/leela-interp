...
def main(args):
    ...
    if args.generate:
        if (base_dir / "unfiltered_puzzles_no_forcing.pkl").exists():
        ...
        with open(base_dir / "unfiltered_puzzles_no_forcing.pkl", "wb") as f:
            pickle.dump(puzzles, f)

    else:
        try:
            with open(base_dir / "unfiltered_puzzles_no_forcing.pkl", "rb") as f:
    ...
    with open(base_dir / "interesting_puzzles_no_forcing_without_corruptions.pkl", "wb") as f:
        pickle.dump(puzzles, f)
